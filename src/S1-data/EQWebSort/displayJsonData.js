...
const displayJsonData = function (id, JsonObj, projectName) {
  ...
  let temp1, sort0, sortArray, replaced, tempString1;
  ...
  console.log("called");
  let multiplierArrayCalc = calcMultiplierArrayT2([...qSortPattern]);
  console.log(multiplierArrayCalc);
  ...
  returnObject = {
    ...
    multiplierArray: [...multiplierArrayCalc],
