...
const doInputErrorCheck = function() {
    ...
    if (testLen !== statements.length) {
        isError = true;
        let errorMessage = "The number of statements does not match the number of sort values listed in the Q-sort pattern";
        return [isError, [errorMessage, "", ""]];
    }
    ...
    if (excelType1ErrorCheck !== "") {
        isError = true;
        let message1 = "There are Q sorts with incorrect or duplicate statement numbers";
