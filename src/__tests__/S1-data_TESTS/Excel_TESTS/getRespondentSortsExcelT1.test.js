import { getRespondentSortsExcelT1 } from "../../../S1-data/Excel1/getRespondentSortsExcelT1";
...
test("should pull respondent sorts", () => {
  let value1 = getRespondentSortsExcelT1(parameter1, parameter2, parameter3);
