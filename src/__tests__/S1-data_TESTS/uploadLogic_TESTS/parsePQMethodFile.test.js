...
test("parse pqmethod file", () => {
  let value1 = parsePQMethodFile(parameter1);
  expect(value1[0]).toEqual(testValue1);
  expect(value1[1]).toEqual(testValue2);
  expect(value1[2]).toEqual(testValue3);
  expect(value1[3]).toEqual(testValue4);
  expect(value1[4]).toEqual(testValue5);
  expect(value1[5]).toEqual(testValue6);
});
