...
// JSlint declarations
/* global localStorage: false, console: false, $: false, _: false, document: false*/
...
$(document).ready(function () {
    ...
    // extract centroid factors button listener
    $("#factorExtractionButton").on("click", function () {
        fireFactorExtraction();
        $(this).removeClass("blackHover").addClass("buttonActionComplete").prop('value', 'Factors Extracted').prop('disabled', true);
    });

    // extract centroid factors button listener
    $("#factorSelect").change(function () {
        $("#factorExtractionButton").removeClass("buttonActionComplete").addClass("blackHover").prop('value', 'Extract Centroid Factors').prop('disabled', false);
    });
