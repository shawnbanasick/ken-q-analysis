...
var resources = {
    ...
    "ja": {
        "translation": {
            ...
            "Names are truncated to 8 characters for PQMethod export": "（回答者の名前はローマ字八字までに入力）",
            ...
            "Excel File": "エクセルファイル",
            "Upload user-coded excel file": "利用者が作ったエクセルファイルをアップロードする",
            "Upload ken-q results file": "Ken-Qの分析結果ファイルをアップロード",
            "Export q-sorts to pqmethod": "Q-sortsをPQMethodフォーマットでダウンロード",
            "Download a user-coded excel example file here": "利用者が作った例のエクセルファイルのダウンロード",
            "Demo Data": "デモ　データ",
